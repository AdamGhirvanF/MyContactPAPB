...
{
    //Init var
    private ArrayList<ContactModel> contactList = new
            ArrayList<>();
    private ContactAdapter contactAdapter;
    private RecyclerView recyclerView;
    private TextView option;
    private LinearLayout layAddContact;
    private EditText etName, etNumber, etInstagram,
            etGroup;
    private Button btnClear, btnSubmit;
    @Override
    protected void onCreate(Bundle savedInstanceState)
    {
        contactList.add(new ContactModel("Jusuf Latifah",
        ...
        contactList.add(new ContactModel("Burhanuddin Taufik", "+628785555041", "family", "integersjunior"));
                contactList.add(new ContactModel("Latifah Bagus", "+628785555042", "study", "clearcarbon"));
                        contactList.add(new ContactModel("Agung Nurul",
        ...
        RecyclerView.LayoutManager layoutManager = new
                LinearLayoutManager(ContactActivity.this);
        ...
        recyclerView =
                findViewById(R.id.recycle_contact);
